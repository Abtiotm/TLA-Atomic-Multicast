...
\setboolean{shading}{true}
 ...
 {\MODULE} WhiteBoxMulticast}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The specification of the White-Box \ensuremath{Multicast} protocol for atomic
 multicast;
 see Section \ensuremath{IV} of the \ensuremath{DSN2019} paper ``White-Box
...
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} Injective ( f ) \.{\defeq}
 \A\, a ,\, b \.{\in} {\DOMAIN} f \.{:} ( a \.{\neq} b ) \.{\implies} ( f [ a
 ] \.{\neq} f [ b ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Max ( a ,\, b ) \.{\defeq}
 {\IF} a \.{>} b \.{\THEN} a \.{\ELSE} b}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\CONSTANTS}}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} Msg ,\,\@s{17.18}}%
\@y{\@s{0}%
 the set of messages, ranged over by \ensuremath{m
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} Proc ,\,\@s{15.47}}%
\@y{\@s{0}%
 the set of processes, ranged over by \ensuremath{p
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} Group ,\,\@s{8.06}}%
\@y{\@s{0}%
 the set of groups, ranged over by \ensuremath{g
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} Leader
 ,\,\@s{5.76}}%
\@y{\@s{0}%
 \ensuremath{Leader[g] \.{\in} Proc}: the leader of the group \ensuremath{g
 \.{\in} Group
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} Member ,\,}%
\@y{\@s{0}%
 \ensuremath{Member[g] \.{\subseteq} Proc}: the members of the group
 \ensuremath{g \.{\in} Group
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} Dest\@s{21.32}}%
\@y{\@s{0}%
 \ensuremath{Dest[m] \.{\subseteq} Group}: the set of destination groups of
 \ensuremath{m \.{\in} Msg
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} {\ASSUME}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land}
 Leader\@s{5.76} \.{\in} [ Group \.{\rightarrow} Proc ]}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\land} Member
 \.{\in} [ Group \.{\rightarrow} {\SUBSET} Proc ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land} \A\, g
 \.{\in} Group \.{:} Leader [ g ] \.{\in} Member [ g ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land} \A\, g1
 ,\, g2 \.{\in} Group \.{:} Member [ g1 ] \.{\cap} Member [ g2 ] \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} Dest
 \.{\in} [ Msg \.{\rightarrow} {\SUBSET} Group ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} Priority \.{\defeq}
 {\CHOOSE} f \.{\in} [ Group \.{\rightarrow} 1 \.{\dotdot} Cardinality (
 Group ) ] \.{:} Injective ( f )}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} {\VARIABLES}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} clock
 ,\,\@s{22.30}}%
\@y{\@s{0}%
 \ensuremath{clock[p]}: the clock at process \ensuremath{p \.{\in} Proc
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} phase
 ,\,\@s{19.56}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} localTS
 ,\,\@s{11.45}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} globalTS
 ,\,\@s{6.34}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} delivered
 ,\,\@s{5.86}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} incoming
 ,\,\@s{8.2}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} sent\@s{31.86}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} pvars \.{\defeq} {\langle}
 clock ,\, phase ,\, localTS ,\, globalTS ,\, delivered {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} vars \.{\defeq} {\langle}
 clock ,\, phase ,\, localTS ,\, globalTS ,\, delivered ,\, incoming ,\, sent
 {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} MaxCounter \.{\defeq}
 Cardinality ( Msg ) \.{*} Cardinality ( Group )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} TS \.{\defeq} [ c \.{:} 0
 \.{\dotdot} MaxCounter ,\, p \.{:} Group ]}%
\@y{\@s{0}%
 \ensuremath{c} for counter
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} GT ( u ,\, v ) \.{\defeq}}%
\@y{\@s{0}%
 Is \ensuremath{u \.{>} v}\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{26.24} \.{\lor} u . c
 \.{>} v . c}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{26.24} \.{\lor} \.{\land}
 u . c \.{=} v . c}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{37.35} \.{\land} Priority
 [ u . p ] \.{>} Priority [ v . p ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} MaxV ( vs ) \.{\defeq}
 {\CHOOSE} u \.{\in} vs \.{:} \A\, v \.{\in} vs \.{:} u \.{\neq} v
 \.{\implies} GT ( u ,\, v )}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{TODO}: type literals as \ensuremath{{\CONSTANTS}
}%
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} Message \.{\defeq} [ type
 \.{:} \{\@w{MULTICAST} \} ,\, m \.{:} Msg ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\cup} [ type
 \.{:} \{\@w{ACCEPT} \} ,\, m \.{:} Msg ,\, g \.{:} Group ,\, lts \.{:} TS ]}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} \.{\cup} [ type
 \.{:} \{\@w{ACCEPTACK} \} ,\, m \.{:} Msg ,\, g \.{:} Proc ]}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\cup} [ type
 \.{:} \{\@w{DELIVER} \} ,\, m \.{:} Msg ,\, lts\@s{11.43} \.{:} TS ,\, gts
 \.{:} TS ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} Send ( msg ) \.{\defeq}}%
\@y{\@s{0}%
 Send \ensuremath{msg \.{\in} Message} to the leaders of its destination
 groups
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{21.98} incoming \.{'}
 \.{=} [ p \.{\in} Proc \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{38.38} {\IF} p \.{\in} \{
 Leader [ g ] \.{:} g \.{\in} Dest [ msg . m ] \} \.{\THEN} incoming [ p ]
 \.{\cup} \{ msg \}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{203.31} \.{\ELSE}
 incoming [ p ] ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{TODO}: to revise it.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} SendAndRemove ( smsg ,\,
 sender ,\, rmsg ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} incoming \.{'}
 \.{=} [ p \.{\in} Proc \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{32.8} {\IF} p \.{=}
 sender \.{\THEN} ( incoming [ sender ] \.{\cup} \{ smsg \} )
 \.{\,\backslash\,} \{ rmsg \}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{93.34} \.{\ELSE} {\IF} p
 \.{\in} Dest [ smsg . m ] \.{\THEN} incoming [ p ] \.{\cup} \{ smsg \}}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{215.51} \.{\ELSE}
 incoming [ p ] ]}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 clock\@s{18.20} \.{\in} [ Proc \.{\rightarrow} 0 \.{\dotdot} MaxCounter ]}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 phase\@s{15.46} \.{\in} [ Proc \.{\rightarrow} [ Msg \.{\rightarrow}
 \{\@w{START} ,\,\@w{PROPOSED} ,\,\@w{ACCEPTED} ,\,\@w{COMMITTED} \} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 localTS\@s{7.35} \.{\in} [ Proc \.{\rightarrow} [ Msg \.{\rightarrow} TS ]
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 globalTS\@s{2.24} \.{\in} [ Proc \.{\rightarrow} [ Msg \.{\rightarrow} TS ]
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 delivered\@s{1.76} \.{\in} [ Proc \.{\rightarrow} [ Msg \.{\rightarrow}
 {\BOOLEAN} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 incoming \.{\in} [ Proc \.{\rightarrow} {\SUBSET} Message ]}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 sent\@s{20.5} \.{\subseteq} Msg}%
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \.{\land}
 ...
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{16.4} \.{\land}
 ...
 Msg \.{\mapsto} {\FALSE} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\land}
 incoming\@s{4.1} \.{=} [ p \.{\in} Proc \.{\mapsto} \{ \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\land}
 sent\@s{21.65} \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} multicast ( m ) \.{\defeq}}%
\@y{\@s{0}%
 multicast \ensuremath{m \.{\in} Msg
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{16.4} \.{\land} m
 \.{\in} Msg \.{\,\backslash\,} sent}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{16.4} \.{\land} sent
 \.{'} \.{=} sent \.{\cup} \{ m \}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\land} Send ( [
 type \.{\mapsto}\@w{MULTICAST} ,\, m \.{\mapsto} m ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} pvars}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}} Multicast \.{\defeq}
 {\FALSE}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}}%
\@y{%
 \ensuremath{Propose(p) \.{\defeq} \.{\,\backslash\,}\.{*}} When
 \ensuremath{p \.{\in} Proc} receives a \ensuremath{MULTICAST} for some
 \ensuremath{m \.{\in} Msg
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\E\, msg \.{\in} incoming[p]}:
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}}%
\@y{\@s{17.5}%
 \ensuremath{\.{\land} msg.type \.{=} \@w{MULTICAST}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}}%
\@y{\@s{17.5}%
 \ensuremath{\.{\land} \.{\LET} m \.{\defeq} msg.m
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}}%
\@y{\@s{25.0}%
 \ensuremath{\.{\IN} \.{\land} Assert(p \.{\in} Dest[m],\, \mbox{``}p}
 \ensuremath{should} \ensuremath{be} \ensuremath{one} \ensuremath{of}
 \ensuremath{the} \ensuremath{destination} \ensuremath{process}
 \ensuremath{of} \ensuremath{m\mbox{''})
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}}%
\@y{\@s{35.0}%
 \ensuremath{\.{\land} clock\.{'} \.{=}} [clock \ensuremath{{\EXCEPT}
 {\bang}[p] \.{=}} @ + 1]
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}}%
\@y{\@s{35.0}%
 \ensuremath{\.{\land} localTS\.{'} \.{=}} [\ensuremath{localTS}
 \ensuremath{{\EXCEPT} {\bang}[p][m] \.{=}} [\ensuremath{c \.{\mapsto}
 clock\.{'}[p]}, \ensuremath{p \.{\mapsto} p}]]
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}}%
\@y{\@s{35.0}%
 \ensuremath{\.{\land} phase\.{'} \.{=}} [phase \ensuremath{{\EXCEPT}
 {\bang}[p][m] \.{=} \@w{PROPOSED}}]
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}}%
\@y{\@s{35.0}%
 \ensuremath{\.{\land} SendAndRemove([type \.{\mapsto} \@w{PROPOSE},\, m
 \.{\mapsto} m,\, p \.{\mapsto} p,\,
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}}%
\@y{\@s{82.5}%
 \ensuremath{lts \.{\mapsto} localTS\.{'}[p][m]}], \ensuremath{p},
 \ensuremath{msg})
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}}%
\@y{\@s{35.0}%
 \ensuremath{\.{\land} {\UNCHANGED} {\langle}globalTS,\, delivered,\,
 sent{\rangle}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 30 23:05:23 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Fri}
 \ensuremath{Jul} 30 19:56:43 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
